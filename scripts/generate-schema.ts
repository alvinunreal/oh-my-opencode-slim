...
const outputPath = join(rootDir, 'oh-my-opencode-ultraslim.schema.json');
...
const jsonSchema = {
  ...
  title: 'oh-my-opencode-ultraslim',
  description:
    'Configuration schema for oh-my-opencode-ultraslim plugin for OpenCode',
};
