...
const suspiciousPathPatterns = [
  /\/Users\/[^\s'"`]+(?:node_modules|oh-my-opencode-ultraslim)[^\s'"`]*/,
  /\/home\/[^\s'"`]+(?:node_modules|oh-my-opencode-ultraslim)[^\s'"`]*/,
];
...
const packagedRequiredFiles = [
  ...
  'dist/index.d.ts',
  'dist/cli/index.js',
  'oh-my-opencode-ultraslim.schema.json',
...
function verifyFreshInstall(tarballPath: string) {
  ...
  try {
    ...
    const smokeScript = [
      "import pkg from 'oh-my-opencode-ultraslim';",
