...
describe('auto-update-checker/checker', () => {
  ...
  describe('findPluginEntry', () => {
    test('detects latest version entry', () => {
      ...
      expect(entry?.entry).toBe('omoslim');
