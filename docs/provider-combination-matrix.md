...
- V1 agents: `oracle=google/antigravity-gemini-3.1-pro`, `orchestrator=google/antigravity-gemini-3.1-pro`, `fixer=openai/gpt-5.1-codex-mini`, `designer=github-copilot/grok-code-fast-1`, `librarian=zai-coding-plan/glm-4.7`, `explorer=google/antigravity-gemini-3-flash`
