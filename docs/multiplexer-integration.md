...
When OpenCode launches child agent sessions, oh-my-opencode-ultraslim can open panes for those sessions automatically.
...
Edit `~/.config/opencode/oh-my-opencode-ultraslim.json` (or `.jsonc`):
